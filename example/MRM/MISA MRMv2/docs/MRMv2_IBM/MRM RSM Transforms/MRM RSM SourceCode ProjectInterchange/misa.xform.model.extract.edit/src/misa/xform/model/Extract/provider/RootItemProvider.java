...
/**
 * This is the item provider adapter for a {@link misa.xform.model.Extract.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_targetProject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_targetProject_feature", "_UI_Root_type"),
				 ExtractPackage.Literals.ROOT__TARGET_PROJECT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExtractPackage.Literals.ROOT__CLASS_DEF);
		}
	...
	public String getText(Object object) {
		String label = ((Root)object).getTargetProject();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExtractPackage.Literals.ROOT__CLASS_DEF,
				 ExtractFactory.eINSTANCE.createClassDef()));
	}
